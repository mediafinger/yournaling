class CreateBenchmarkTables < ActiveRecord::Migration[7.1]
  def change
    ...
    create_table :benchmark_rails_yids, primary_key: "yid", id: :string do |t|
    ...
    create_table :benchmark_uuids, primary_key: "yid", id: :uuid do |t|
      t.string :team_yid, null: false
      t.string :name, null: false
    ...
    create_table :benchmark_ids, primary_key: "yid" do |t|
      t.string :team_yid, null: false
      t.string :name, null: false
