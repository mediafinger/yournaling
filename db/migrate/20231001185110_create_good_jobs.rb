...
class CreateGoodJobs < ActiveRecord::Migration[7.1]
  def change
    ...
    #   # add_index :good_jobs, %i[active_job_id], name: :index_good_jobs_on_active_job_id # redundant to %i[active_job_id created_at] index
    ...
    #   add_index :good_jobs, %i[concurrency_key], where: "(finished_at IS NULL)", name: :index_good_jobs_on_concurrency_key_when_unfinished
    ...
    #   add_index :good_jobs, %i[priority created_at], order: { priority: "DESC NULLS LAST", created_at: :asc }, where: "finished_at IS NULL", name: :index_good_jobs_jobs_on_priority_created_at_when_unfinished
    ...
    #   add_index :good_jobs, %i[scheduled_at], where: "(finished_at IS NULL)", name: "index_good_jobs_on_scheduled_at"
