...
User.create_with_event(record: andy, event_params: { team: Team.new(id: :none), user: User.new(id: :admin) })
User.create_with_event(record: dodo, event_params: { team: Team.new(id: :none), user: User.new(id: :admin) })
User.create_with_event(record: user, event_params: { team: Team.new(id: :none), user: User.new(id: :admin) })

van = Team.new(name: "RanTanVan")
team = Team.new(name: "team two")
Team.create_with_event(record: van, event_params: { team: van, user: User.new(id: :admin) })
Team.create_with_event(record: team, event_params: { team: team, user: User.new(id: :admin) })
