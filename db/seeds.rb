...
User.create_with_history(record: dodo, history_params: { team: Team.new(id: :none), user: User.new(id: :admin) })
User.create_with_history(record: user, history_params: { team: Team.new(id: :none), user: User.new(id: :admin) })
...
Team.create_with_history(record: team, history_params: { team: team, user: User.new(id: :admin) })
