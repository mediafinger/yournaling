...
module Example
  ...
  class FieldComponentPreview < ViewComponent::Preview
    ...
    def playground(
      ...
      render Example::FieldComponent.new(
    ...
    def text_input
      render(Example::FieldComponent.new(label: "Title", name: "memory[title]", required: true,
        placeholder: "A short name for this memory"))
    end

    def textarea
      render(Example::FieldComponent.new(label: "Notes", name: "memory[notes]", as: :textarea,
        hint: "Markdown is supported."))
    end

    def select
      render(Example::FieldComponent.new(label: "Visibility", name: "memory[visibility]", as: :select, value: "team",
        options: [["Private — only me", "private"], ["Team", "team"],
                  ["Public", "public"]]))
    end

    def with_error
      render(Example::FieldComponent.new(label: "Email", name: "email", type: "email", value: "andy@",
