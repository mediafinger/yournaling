...
module Yui
  ...
  class FigureComponentPreview < ViewComponent::Preview
    ...
    def playground(caption: "Day 4 — the northern beach", ratio: "3/2")
      render Yui::FigureComponent.new(src: PHOTO, alt: "The northern beach at dusk", caption: caption.presence, ratio:)
    end

    def with_caption
      render(Yui::FigureComponent.new(src: PHOTO, alt: "The northern beach", caption: "Day 4 — the northern beach",
        ratio: "3/2"))
    end

    def square
      render(Yui::FigureComponent.new(src: PHOTO, alt: "", ratio: "1/1"))
    end
  end
end
