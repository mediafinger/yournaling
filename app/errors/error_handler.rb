module ErrorHandler
  ...
  MAP_RAILS_ERRORS = {
    ...
    "ActionController::InvalidAuthenticityToken"   => { code: :unprocessable_content, status: 422 },
    "ActionController::InvalidCrossOriginRequest"  => { code: :unprocessable_content, status: 422 },
    "ActiveRecord::RecordInvalid"                  => { code: :unprocessable_content, status: 422 },
    "ActiveRecord::RecordNotSaved"                 => { code: :unprocessable_content, status: 422 },
