class UsersController < ApplicationController
  ...
  def create
    ...
    User.create_with_event(record: @user, event_params: { team: Team.new(yid: :none), user: @user })
  ...
  def update
    ...
    User.update_with_event(record: @user, event_params: { team: Team.new(yid: :none), user: current_user })
  ...
  def destroy
    ...
    User.destroy_with_event(record: @user, event_params: { team: Team.new(yid: :none), user: current_user })
