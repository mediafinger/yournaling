...
module Example
  ...
  #
  #   Example::LinkComponent.new("Read the chronicle", href: "/chronicles/1")
  #   Example::LinkComponent.new("mediafinger.com", href: "https://mediafinger.com", external: true)
  #   = render(Example::LinkComponent.new(href: "#", variant: :standalone)) { "See every memory" }
  #
  ...
  class LinkComponent < BaseComponent
    ...
    slim_template <<~SLIM
      = link_to(href, link_options) do
        = text
        - if trailing_icon
          = render(Example::IconComponent.new(trailing_icon, size: :sm))
    SLIM
  end
end
