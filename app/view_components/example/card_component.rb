...
module Example
  ...
  #       = image_tag(...)
  #     - card.with_header do
  #       = render(Example::HeadlineComponent.new("Northern beach", level: 3))
  #     p The tide took the rest.
  #     - card.with_footer do
  #       = render(Example::ButtonComponent.new("Open", size: :sm, variant: :secondary))
  #
